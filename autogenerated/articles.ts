...
<span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">BasicLogger</span> <span class="k">implements</span> <span class="nx">ILogger</span><span class="p">${"$"}{"{"${"$"}{"}"}</span>
  ...
  <span class="nf">setLevel</span><span class="p">(</span><span class="nx">level</span><span class="p">:</span> <span class="nx">LogLevel</span><span class="p">):</span> <span class="k">void</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    ...
    <span class="nf">switch </span><span class="p">(</span><span class="k">this</span><span class="p">.</span><span class="nx">level</span><span class="p">)${"$"}{"{"${"$"}{"}"}</span>
  ...
  <span class="nf">debug</span><span class="p">(...</span><span class="nx">obj</span><span class="p">:</span> <span class="kr">any</span><span class="p">[]):</span> <span class="k">void</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    <span class="nf">if </span><span class="p">(</span><span class="k">this</span><span class="p">.</span><span class="nx">whiteList</span><span class="p">.</span><span class="nf">has</span><span class="p">(</span><span class="dl">'</span><span class="s1">debug</span><span class="dl">'</span><span class="p">))${"$"}{"{"${"$"}{"}"}</span>
  ...
  <span class="nf">info</span><span class="p">(...</span><span class="nx">obj</span><span class="p">:</span> <span class="kr">any</span><span class="p">[]):</span> <span class="k">void</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    <span class="nf">if </span><span class="p">(</span><span class="k">this</span><span class="p">.</span><span class="nx">whiteList</span><span class="p">.</span><span class="nf">has</span><span class="p">(</span><span class="dl">'</span><span class="s1">info</span><span class="dl">'</span><span class="p">))${"$"}{"{"${"$"}{"}"}</span>
  ...
  <span class="nf">warn</span><span class="p">(...</span><span class="nx">obj</span><span class="p">:</span> <span class="kr">any</span><span class="p">[]):</span> <span class="k">void</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    <span class="nf">if </span><span class="p">(</span><span class="k">this</span><span class="p">.</span><span class="nx">whiteList</span><span class="p">.</span><span class="nf">has</span><span class="p">(</span><span class="dl">'</span><span class="s1">warn</span><span class="dl">'</span><span class="p">))${"$"}{"{"${"$"}{"}"}</span>
  ...
  <span class="nf">error</span><span class="p">(...</span><span class="nx">obj</span><span class="p">:</span> <span class="kr">any</span><span class="p">[]):</span> <span class="k">void</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    <span class="nf">if </span><span class="p">(</span><span class="k">this</span><span class="p">.</span><span class="nx">whiteList</span><span class="p">.</span><span class="nf">has</span><span class="p">(</span><span class="dl">'</span><span class="s1">error</span><span class="dl">'</span><span class="p">))${"$"}{"{"${"$"}{"}"}</span>
  ...
  <span class="nf">fatal</span><span class="p">(...</span><span class="nx">obj</span><span class="p">:</span> <span class="kr">any</span><span class="p">[]):</span> <span class="k">void</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    <span class="nf">if </span><span class="p">(</span><span class="k">this</span><span class="p">.</span><span class="nx">whiteList</span><span class="p">.</span><span class="nf">has</span><span class="p">(</span><span class="dl">'</span><span class="s1">fatal</span><span class="dl">'</span><span class="p">))${"$"}{"{"${"$"}{"}"}</span>
...
<span class="kd">class</span> <span class="nc">ConsoleLogger</span> <span class="kd">extends</span> <span class="nc">BasicLogger</span><span class="p">${"$"}{"{"${"$"}{"}"}</span>
  <span class="nf">constructor</span><span class="p">(</span><span class="nx">logLevel</span><span class="p">:</span> <span class="nx">LogLevel</span><span class="p">)</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    <span class="nf">super</span><span class="p">(</span><span class="nx">logLevel</span><span class="p">)</span>
  <span class="p">${"$"}{"}"}</span>
  ...
  <span class="nf">log</span><span class="p">(</span><span class="nx">logLevel</span><span class="p">:</span> <span class="nx">LogLevel</span><span class="p">,</span> <span class="p">...</span><span class="nx">obj</span><span class="p">:</span> <span class="kr">any</span><span class="p">[]):</span> <span class="k">void</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    ...
    <span class="nf">switch</span><span class="p">(</span><span class="nx">logLevel</span><span class="p">)${"$"}{"{"${"$"}{"}"}</span>
...
<span class="n">response</span> <span class="o">=</span> <span class="n">requests</span><span class="p">.</span><span class="nf">get</span><span class="p">(</span><span class="s">'https://qiita.com/api/v2/items?query=user:sYamaz'</span><span class="p">)</span>
...
<span class="k">def</span> <span class="nf">escape</span><span class="p">(</span><span class="nb">input</span><span class="p">:</span><span class="nb">str</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
  <span class="k">return</span> <span class="nb">input</span><span class="p">.</span><span class="nf">replace</span><span class="p">(</span><span class="s">'</span><span class="se">\\\\</span><span class="s">'</span><span class="p">,</span> <span class="s">'</span><span class="se">\\\\\\\\</span><span class="s">'</span><span class="p">)</span>\\
...
<span class="k">def</span> <span class="nf">Group</span><span class="p">(</span><span class="n">grp</span><span class="p">:</span><span class="nb">dict</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
  ...
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'created_at: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">created_at</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'description: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">description</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'name: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">name</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'private: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="nf">str</span><span class="p">(</span><span class="n">private</span><span class="p">).</span><span class="n">lower</span><span class="si">${"$"}{"}"}</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'updated_at: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">updated_at</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'url_name: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">url_name</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="k">return</span> <span class="s">'${"$"}{"{"${"$"}{"}"}'</span> <span class="o">+</span> <span class="s">',</span><span class="se">\\n</span><span class="s">'</span><span class="p">.</span><span class="nf">join</span><span class="p">(</span><span class="n">arr</span><span class="p">)</span> <span class="o">+</span>  <span class="s">'${"$"}{"}"}'</span>
...
<span class="k">def</span> <span class="nf">Tag</span><span class="p">(</span><span class="n">tag</span><span class="p">:</span><span class="nb">dict</span><span class="p">):</span>
  ...
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'name: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">name</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">vals</span> <span class="o">=</span> <span class="n">delimiter</span><span class="p">.</span><span class="nf">join</span><span class="p">(</span><span class="nf">map</span><span class="p">(</span><span class="k">lambda</span> <span class="n">v</span><span class="p">:</span> <span class="sa">f</span><span class="s">'</span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">v</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span> <span class="p">,</span><span class="n">versions</span><span class="p">))</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'versions: [ </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">vals</span><span class="si">${"$"}{"}"}</span><span class="s"> ]'</span><span class="p">)</span>
  <span class="k">return</span> <span class="s">'${"$"}{"{"${"$"}{"}"}'</span> <span class="o">+</span> <span class="n">delimiter</span><span class="p">.</span><span class="nf">join</span><span class="p">(</span><span class="n">arr</span><span class="p">)</span> <span class="o">+</span> <span class="s">'${"$"}{"}"}'</span>
...
<span class="k">def</span> <span class="nf">Tags</span><span class="p">(</span><span class="n">tags</span><span class="p">):</span>
  ...
  <span class="k">return</span> <span class="s">'['</span> <span class="o">+</span> <span class="s">','</span><span class="p">.</span><span class="nf">join</span><span class="p">(</span><span class="n">arr</span><span class="p">)</span> <span class="o">+</span> <span class="s">']'</span>
...
<span class="k">def</span> <span class="nf">User</span><span class="p">(</span><span class="n">user</span><span class="p">:</span><span class="nb">dict</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
  ...
  <span class="n">arr</span> <span class="o">=</span> <span class="p">[]</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'description: \`</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">description</span><span class="si">${"$"}{"}"}</span><span class="s">\`'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'facebook_id: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">facebook_id</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'followees_count: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">followees_count</span><span class="si">${"$"}{"}"}</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'followers_count: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">followers_count</span><span class="si">${"$"}{"}"}</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'github_login_name: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">github_login_name</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'id: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="nb">id</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'items_count: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">items_count</span><span class="si">${"$"}{"}"}</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'linkedin_id: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">linkedin_id</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'location: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">location</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'name: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">name</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'organization: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">organization</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'permanent_id: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">permanent_id</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'profile_image_url: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">profile_image_url</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'team_only: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="nf">str</span><span class="p">(</span><span class="n">team_only</span><span class="p">).</span><span class="nf">lower</span><span class="p">()</span><span class="si">${"$"}{"}"}</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'twitter_screen_name: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">twitter_screen_name</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'website_url: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">website_url</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
...
<span class="k">def</span> <span class="nf">Item</span><span class="p">(</span><span class="n">item</span><span class="p">:</span><span class="nb">dict</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
  <span class="n">arr</span> <span class="o">=</span> <span class="p">[]</span>
  <span class="n">rendered_body</span> <span class="o">=</span> <span class="nf">escape</span><span class="p">(</span><span class="n">item</span><span class="p">[</span><span class="s">'rendered_body'</span><span class="p">])</span>
  <span class="n">body</span> <span class="o">=</span> <span class="nf">escape</span><span class="p">(</span><span class="n">item</span><span class="p">[</span><span class="s">'body'</span><span class="p">])</span>
  ...
  <span class="n">group</span> <span class="o">=</span> <span class="nc">Group</span><span class="p">(</span><span class="n">item</span><span class="p">[</span><span class="s">'group'</span><span class="p">])</span> <span class="k">if</span> <span class="s">'group'</span> <span class="ow">in</span> <span class="n">item</span> <span class="k">else</span> <span class="nc">Empty</span><span class="p">()</span>
  ...
  <span class="n">tags</span> <span class="o">=</span> <span class="nc">Tags</span><span class="p">(</span><span class="n">item</span><span class="p">[</span><span class="s">'tags'</span><span class="p">])</span> <span class="k">if</span> <span class="s">'tags'</span> <span class="ow">in</span> <span class="n">item</span> <span class="k">else</span> <span class="s">'[]'</span>
  ...
  <span class="n">user</span> <span class="o">=</span> <span class="nc">User</span><span class="p">(</span><span class="n">item</span><span class="p">[</span><span class="s">'user'</span><span class="p">])</span> <span class="k">if</span> <span class="s">'user'</span> <span class="ow">in</span> <span class="n">item</span> <span class="k">else</span> <span class="nc">Empty</span><span class="p">()</span>
  ...
  <span class="n">team_membership</span> <span class="o">=</span> <span class="nc">TeamMembership</span><span class="p">(</span><span class="n">item</span><span class="p">[</span><span class="s">'team_membership'</span><span class="p">])</span> <span class="k">if</span> <span class="s">'team_membership'</span> <span class="ow">in</span> <span class="n">item</span> <span class="k">else</span> <span class="nc">Empty</span><span class="p">()</span>

  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'rendered_body: \`</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">rendered_body</span><span class="si">${"$"}{"}"}</span><span class="s">\`'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'body: \`</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">body</span><span class="si">${"$"}{"}"}</span><span class="s">\`'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'coediting: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="nf">str</span><span class="p">(</span><span class="n">coediting</span><span class="p">).</span><span class="nf">lower</span><span class="p">()</span><span class="si">${"$"}{"}"}</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'comments_count: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">comments_count</span><span class="si">${"$"}{"}"}</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'created_at: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">created_at</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'group: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">group</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'id: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="nb">id</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'likes_count: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">likes_count</span><span class="si">${"$"}{"}"}</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'private: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="nf">str</span><span class="p">(</span><span class="n">private</span><span class="p">).</span><span class="nf">lower</span><span class="p">()</span><span class="si">${"$"}{"}"}</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'reactions_count: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">reactions_count</span><span class="si">${"$"}{"}"}</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'tags: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">tags</span><span class="si">${"$"}{"}"}</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'title: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">title</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'updated_at: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">updated_at</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'url: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">url</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'user: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">user</span><span class="si">${"$"}{"}"}</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'page_views_count: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="s">"null"</span> <span class="k">if</span> <span class="n">page_views_count</span> <span class="ow">is</span> <span class="bp">None</span> <span class="k">else</span> <span class="n">page_views_count</span><span class="si">${"$"}{"}"}</span><span class="s">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="s">'team_membership: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">team_membership</span><span class="si">${"$"}{"}"}</span><span class="s">'</span><span class="p">)</span>
...
<span class="k">def</span> <span class="nf">main</span><span class="p">(</span><span class="n">out_path</span><span class="p">):</span>
  ...
  <span class="n">text</span> <span class="o">=</span> <span class="s">'export const articles = ['</span> <span class="o">+</span> <span class="s">','</span><span class="p">.</span><span class="nf">join</span><span class="p">(</span><span class="n">lines</span><span class="p">)</span> <span class="o">+</span> <span class="s">']'</span>
  ...
  <span class="n">f</span> <span class="o">=</span> <span class="n">io</span><span class="p">.</span><span class="nf">open</span><span class="p">(</span><span class="n">out_path</span><span class="p">,</span> <span class="s">'w'</span><span class="p">)</span>
