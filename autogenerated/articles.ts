export const articles = [{rendered_body: `<p data-sourcepos="1:1-1:118">nuxt3でログ出力したいとき、provideを活用するといいのでは？というのを思ってtry中です.</p>
<h2 data-sourcepos="3:1-3:21">
<span id="期待すること" class="fragment"></span><a href="#%E6%9C%9F%E5%BE%85%E3%81%99%E3%82%8B%E3%81%93%E3%81%A8"><i class="fa fa-link"></i></a>期待すること</h2>
<p data-sourcepos="5:1-7:82">将来的にOSSのログモジュールを使用することになっても変更が最小で済むこと。<br>
またはログをバックエンドに送る場合にも変更が最小で済むこと。<br>
（pageやcomponentといったロガーの使用者側に影響がないこと）</p>
<h2 data-sourcepos="9:1-9:9">
<span id="実装" class="fragment"></span><a href="#%E5%AE%9F%E8%A3%85"><i class="fa fa-link"></i></a>実装</h2>
<p data-sourcepos="11:1-11:7">provide</p>
<div class="code-frame" data-lang="typescript" data-sourcepos="13:1-130:3"><div class="highlight"><pre><code><span class="c1">// /plugins/logger.ts</span>
<span class="kd">type</span> <span class="nx">LogLevel</span> <span class="o">=</span> <span class="dl">'</span><span class="s1">debug</span><span class="dl">'</span> <span class="o">|</span> <span class="dl">'</span><span class="s1">info</span><span class="dl">'</span> <span class="o">|</span> <span class="dl">'</span><span class="s1">warn</span><span class="dl">'</span> <span class="o">|</span> <span class="dl">'</span><span class="s1">error</span><span class="dl">'</span> <span class="o">|</span> <span class="dl">'</span><span class="s1">fatal</span><span class="dl">'</span>

<span class="cm">/** 公開される型 */</span>
<span class="k">export</span> <span class="kr">interface</span> <span class="nx">ILogger</span><span class="p">${"$"}{"{"${"$"}{"}"}</span>
  <span class="nf">debug</span><span class="p">(...</span><span class="nx">obj</span><span class="p">:</span> <span class="kr">any</span><span class="p">[]):</span> <span class="k">void</span>
  <span class="nf">info</span><span class="p">(...</span><span class="nx">obj</span><span class="p">:</span> <span class="kr">any</span><span class="p">[]):</span> <span class="k">void</span>
  <span class="nf">warn</span><span class="p">(...</span><span class="nx">obj</span><span class="p">:</span> <span class="kr">any</span><span class="p">[]):</span> <span class="k">void</span>
  <span class="nf">error</span><span class="p">(...</span><span class="nx">obj</span><span class="p">:</span> <span class="kr">any</span><span class="p">[]):</span> <span class="k">void</span>
  <span class="nf">fatal</span><span class="p">(...</span><span class="nx">obj</span><span class="p">:</span> <span class="kr">any</span><span class="p">[]):</span> <span class="k">void</span>
  <span class="cm">/** logLevelの変更 */</span>
  <span class="nf">setLevel</span><span class="p">(</span><span class="nx">level</span><span class="p">:</span> <span class="nx">LogLevel</span><span class="p">):</span><span class="k">void</span>
  <span class="cm">/** 現在のlogLevelの取得 */</span>
  <span class="nf">getLevel</span><span class="p">():</span> <span class="nx">LogLevel</span>
<span class="p">${"$"}{"}"}</span>

<span class="cm">/** インターフェースの実装は公開されない */</span>
<span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">BasicLogger</span> <span class="k">implements</span> <span class="nx">ILogger</span><span class="p">${"$"}{"{"${"$"}{"}"}</span>
  <span class="k">private</span> <span class="nx">level</span><span class="p">:</span><span class="nx">LogLevel</span> <span class="o">=</span> <span class="dl">'</span><span class="s1">info</span><span class="dl">'</span>
  <span class="k">private</span> <span class="nx">whiteList</span><span class="p">:</span><span class="nb">Set</span><span class="o">&lt;</span><span class="nx">LogLevel</span><span class="o">&gt;</span> <span class="o">=</span> <span class="k">new</span> <span class="nb">Set</span><span class="o">&lt;</span><span class="nx">LogLevel</span><span class="o">&gt;</span><span class="p">([</span><span class="dl">'</span><span class="s1">info</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">warn</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">error</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">fatal</span><span class="dl">'</span><span class="p">])</span>
  
  <span class="nf">constructor</span><span class="p">(</span><span class="nx">level</span><span class="p">:</span><span class="nx">LogLevel</span> <span class="o">=</span> <span class="dl">'</span><span class="s1">info</span><span class="dl">'</span><span class="p">)</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    <span class="k">this</span><span class="p">.</span><span class="nf">setLevel</span><span class="p">(</span><span class="nx">level</span><span class="p">)</span>
  <span class="p">${"$"}{"}"}</span>

  <span class="nf">getLevel</span><span class="p">():</span> <span class="nx">LogLevel</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    <span class="k">return</span> <span class="k">this</span><span class="p">.</span><span class="nx">level</span>
  <span class="p">${"$"}{"}"}</span>

  <span class="nf">setLevel</span><span class="p">(</span><span class="nx">level</span><span class="p">:</span> <span class="nx">LogLevel</span><span class="p">):</span> <span class="k">void</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    <span class="k">this</span><span class="p">.</span><span class="nx">level</span> <span class="o">=</span> <span class="nx">level</span>
    <span class="k">switch </span><span class="p">(</span><span class="k">this</span><span class="p">.</span><span class="nx">level</span><span class="p">)${"$"}{"{"${"$"}{"}"}</span>
      <span class="k">case</span> <span class="dl">'</span><span class="s1">debug</span><span class="dl">'</span><span class="p">:</span>
        <span class="k">this</span><span class="p">.</span><span class="nx">whiteList</span> <span class="o">=</span> <span class="k">new</span> <span class="nb">Set</span><span class="o">&lt;</span><span class="nx">LogLevel</span><span class="o">&gt;</span><span class="p">([</span><span class="dl">'</span><span class="s1">debug</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">info</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">warn</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">error</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">fatal</span><span class="dl">'</span><span class="p">])</span>
        <span class="k">return</span>
      <span class="k">case</span> <span class="dl">'</span><span class="s1">info</span><span class="dl">'</span><span class="p">:</span>
        <span class="k">this</span><span class="p">.</span><span class="nx">whiteList</span> <span class="o">=</span> <span class="k">new</span> <span class="nb">Set</span><span class="o">&lt;</span><span class="nx">LogLevel</span><span class="o">&gt;</span><span class="p">([</span><span class="dl">'</span><span class="s1">info</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">warn</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">error</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">fatal</span><span class="dl">'</span><span class="p">])</span>
        <span class="k">return</span>
      <span class="k">case</span> <span class="dl">'</span><span class="s1">warn</span><span class="dl">'</span><span class="p">:</span>
        <span class="k">this</span><span class="p">.</span><span class="nx">whiteList</span> <span class="o">=</span> <span class="k">new</span> <span class="nb">Set</span><span class="o">&lt;</span><span class="nx">LogLevel</span><span class="o">&gt;</span><span class="p">([</span><span class="dl">'</span><span class="s1">warn</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">error</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">fatal</span><span class="dl">'</span><span class="p">])</span>
        <span class="k">return</span>
      <span class="k">case</span> <span class="dl">'</span><span class="s1">error</span><span class="dl">'</span><span class="p">:</span>
        <span class="k">this</span><span class="p">.</span><span class="nx">whiteList</span> <span class="o">=</span> <span class="k">new</span> <span class="nb">Set</span><span class="o">&lt;</span><span class="nx">LogLevel</span><span class="o">&gt;</span><span class="p">([</span><span class="dl">'</span><span class="s1">error</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">fatal</span><span class="dl">'</span><span class="p">])</span>
        <span class="k">return</span>
      <span class="k">case</span> <span class="dl">'</span><span class="s1">fatal</span><span class="dl">'</span><span class="p">:</span>
        <span class="k">this</span><span class="p">.</span><span class="nx">whiteList</span> <span class="o">=</span> <span class="k">new</span> <span class="nb">Set</span><span class="o">&lt;</span><span class="nx">LogLevel</span><span class="o">&gt;</span><span class="p">([</span><span class="dl">'</span><span class="s1">fatal</span><span class="dl">'</span><span class="p">])</span>
        <span class="k">return</span>
    <span class="p">${"$"}{"}"}</span>
  <span class="p">${"$"}{"}"}</span>

  <span class="nf">debug</span><span class="p">(...</span><span class="nx">obj</span><span class="p">:</span> <span class="kr">any</span><span class="p">[]):</span> <span class="k">void</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    <span class="k">if </span><span class="p">(</span><span class="k">this</span><span class="p">.</span><span class="nx">whiteList</span><span class="p">.</span><span class="nf">has</span><span class="p">(</span><span class="dl">'</span><span class="s1">debug</span><span class="dl">'</span><span class="p">))${"$"}{"{"${"$"}{"}"}</span>
      <span class="k">this</span><span class="p">.</span><span class="nf">log</span><span class="p">(</span><span class="dl">'</span><span class="s1">debug</span><span class="dl">'</span><span class="p">,</span> <span class="nx">obj</span><span class="p">)</span>
    <span class="p">${"$"}{"}"}</span>
  <span class="p">${"$"}{"}"}</span>
  <span class="nf">info</span><span class="p">(...</span><span class="nx">obj</span><span class="p">:</span> <span class="kr">any</span><span class="p">[]):</span> <span class="k">void</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    <span class="k">if </span><span class="p">(</span><span class="k">this</span><span class="p">.</span><span class="nx">whiteList</span><span class="p">.</span><span class="nf">has</span><span class="p">(</span><span class="dl">'</span><span class="s1">info</span><span class="dl">'</span><span class="p">))${"$"}{"{"${"$"}{"}"}</span>
      <span class="k">this</span><span class="p">.</span><span class="nf">log</span><span class="p">(</span><span class="dl">'</span><span class="s1">info</span><span class="dl">'</span><span class="p">,</span> <span class="nx">obj</span><span class="p">)</span>
    <span class="p">${"$"}{"}"}</span>
  <span class="p">${"$"}{"}"}</span>
  <span class="nf">warn</span><span class="p">(...</span><span class="nx">obj</span><span class="p">:</span> <span class="kr">any</span><span class="p">[]):</span> <span class="k">void</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    <span class="k">if </span><span class="p">(</span><span class="k">this</span><span class="p">.</span><span class="nx">whiteList</span><span class="p">.</span><span class="nf">has</span><span class="p">(</span><span class="dl">'</span><span class="s1">warn</span><span class="dl">'</span><span class="p">))${"$"}{"{"${"$"}{"}"}</span>
      <span class="k">this</span><span class="p">.</span><span class="nf">log</span><span class="p">(</span><span class="dl">'</span><span class="s1">warn</span><span class="dl">'</span><span class="p">,</span> <span class="nx">obj</span><span class="p">)</span>
    <span class="p">${"$"}{"}"}</span>
  <span class="p">${"$"}{"}"}</span>
  <span class="nf">error</span><span class="p">(...</span><span class="nx">obj</span><span class="p">:</span> <span class="kr">any</span><span class="p">[]):</span> <span class="k">void</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    <span class="k">if </span><span class="p">(</span><span class="k">this</span><span class="p">.</span><span class="nx">whiteList</span><span class="p">.</span><span class="nf">has</span><span class="p">(</span><span class="dl">'</span><span class="s1">error</span><span class="dl">'</span><span class="p">))${"$"}{"{"${"$"}{"}"}</span>
      <span class="k">this</span><span class="p">.</span><span class="nf">log</span><span class="p">(</span><span class="dl">'</span><span class="s1">error</span><span class="dl">'</span><span class="p">,</span> <span class="nx">obj</span><span class="p">)</span>
    <span class="p">${"$"}{"}"}</span>
  <span class="p">${"$"}{"}"}</span>
  <span class="nf">fatal</span><span class="p">(...</span><span class="nx">obj</span><span class="p">:</span> <span class="kr">any</span><span class="p">[]):</span> <span class="k">void</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    <span class="k">if </span><span class="p">(</span><span class="k">this</span><span class="p">.</span><span class="nx">whiteList</span><span class="p">.</span><span class="nf">has</span><span class="p">(</span><span class="dl">'</span><span class="s1">fatal</span><span class="dl">'</span><span class="p">))${"$"}{"{"${"$"}{"}"}</span>
      <span class="k">this</span><span class="p">.</span><span class="nf">log</span><span class="p">(</span><span class="dl">'</span><span class="s1">fatal</span><span class="dl">'</span><span class="p">,</span> <span class="nx">obj</span><span class="p">)</span>
    <span class="p">${"$"}{"}"}</span>
  <span class="p">${"$"}{"}"}</span>

  <span class="kd">abstract</span> <span class="nf">log</span><span class="p">(</span><span class="nx">logLevel</span><span class="p">:</span> <span class="nx">LogLevel</span><span class="p">,</span> <span class="p">...</span><span class="nx">obj</span><span class="p">:</span><span class="kr">any</span><span class="p">[]):</span> <span class="k">void</span>
<span class="p">${"$"}{"}"}</span>

<span class="cm">/** インターフェースの実装は公開されない */</span>
<span class="kd">class</span> <span class="nc">ConsoleLogger</span> <span class="kd">extends</span> <span class="nc">BasicLogger</span><span class="p">${"$"}{"{"${"$"}{"}"}</span>
  <span class="nf">constructor</span><span class="p">(</span><span class="nx">logLevel</span><span class="p">:</span> <span class="nx">LogLevel</span><span class="p">)</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    <span class="k">super</span><span class="p">(</span><span class="nx">logLevel</span><span class="p">)</span>
  <span class="p">${"$"}{"}"}</span>

  <span class="nf">log</span><span class="p">(</span><span class="nx">logLevel</span><span class="p">:</span> <span class="nx">LogLevel</span><span class="p">,</span> <span class="p">...</span><span class="nx">obj</span><span class="p">:</span> <span class="kr">any</span><span class="p">[]):</span> <span class="k">void</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    <span class="c1">// </span>
    <span class="c1">// productionではログ出力しないなど</span>
    <span class="c1">// </span>

    <span class="k">switch</span><span class="p">(</span><span class="nx">logLevel</span><span class="p">)${"$"}{"{"${"$"}{"}"}</span>
      <span class="k">case</span> <span class="dl">"</span><span class="s2">fatal</span><span class="dl">"</span><span class="p">:</span>
        <span class="nx">console</span><span class="p">.</span><span class="nf">error</span><span class="p">(</span><span class="nx">logLevel</span><span class="p">,</span> <span class="nx">obj</span><span class="p">)</span>
        <span class="k">return</span>
      <span class="k">case</span> <span class="dl">"</span><span class="s2">error</span><span class="dl">"</span><span class="p">:</span>
        <span class="nx">console</span><span class="p">.</span><span class="nf">error</span><span class="p">(</span><span class="nx">logLevel</span><span class="p">,</span> <span class="nx">obj</span><span class="p">)</span>
        <span class="k">return</span>
      <span class="k">case</span> <span class="dl">"</span><span class="s2">warn</span><span class="dl">"</span><span class="p">:</span>
        <span class="nx">console</span><span class="p">.</span><span class="nf">warn</span><span class="p">(</span><span class="nx">logLevel</span><span class="p">,</span> <span class="nx">obj</span><span class="p">)</span>
        <span class="k">return</span>
      <span class="na">default</span><span class="p">:</span>
        <span class="nx">console</span><span class="p">.</span><span class="nf">log</span><span class="p">(</span><span class="nx">logLevel</span><span class="p">,</span> <span class="nx">obj</span><span class="p">)</span>
        <span class="k">return</span>
    <span class="p">${"$"}{"}"}</span>
  <span class="p">${"$"}{"}"}</span>
<span class="p">${"$"}{"}"}</span>
...
<span class="k">export</span> <span class="k">default</span> <span class="nf">defineNuxtPlugin</span><span class="p">(</span><span class="nx">nuxtApp</span> <span class="o">=&gt;</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
  <span class="kd">const</span> <span class="na">logger</span><span class="p">:</span> <span class="nx">ILogger</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">ConsoleLogger</span><span class="p">(</span><span class="dl">'</span><span class="s1">debug</span><span class="dl">'</span><span class="p">)</span>
  <span class="k">return</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    <span class="na">provide</span><span class="p">:</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
      <span class="na">logger</span><span class="p">:</span> <span class="nx">logger</span>
    <span class="p">${"$"}{"}"}</span>
  <span class="p">${"$"}{"}"}</span>
<span class="p">${"$"}{"}"})</span>

</code></pre></div></div>
<p data-sourcepos="132:1-132:7">page側</p>
<div class="code-frame" data-lang="vuejs" data-sourcepos="134:1-141:3"><div class="highlight"><pre><code><span class="nt">&lt;setup</span> <span class="na">lang=</span><span class="s">"ts"</span> <span class="na">setup</span><span class="nt">&gt;</span>
...
`,body: `nuxt3でログ出力したいとき、provideを活用するといいのでは？というのを思ってtry中です.
...
<p data-sourcepos="3:1-3:51"><iframe id="qiita-embed-content__1d2765c10d79844e75ae81958b9e4458" src="https://qiita.com/embed-contents/link-card#qiita-embed-content__1d2765c10d79844e75ae81958b9e4458" data-content="https%3A%2F%2Fqiita.com%2FsYamaz%2Fitems%2F10c8c9db83e5dad62b90" frameborder="0" scrolling="no" loading="lazy" style="width:100%;" height="29">
</iframe>
</p>
...
<div class="code-frame" data-lang="python" data-sourcepos="16:1-26:3"><div class="highlight"><pre><code><span class="kn">import</span> <span class="n">requests</span>
<span class="kn">import</span> <span class="n">json</span>

<span class="n">response</span> <span class="o">=</span> <span class="n">requests</span><span class="p">.</span><span class="nf">get</span><span class="p">(</span><span class="sh">'</span><span class="s">https://qiita.com/api/v2/items?query=user:sYamaz</span><span class="sh">'</span><span class="p">)</span>

<span class="n">items</span> <span class="o">=</span> <span class="n">json</span><span class="p">.</span><span class="nf">loads</span><span class="p">(</span><span class="n">response</span><span class="p">.</span><span class="n">text</span><span class="p">)</span>
...
<div class="code-frame" data-lang="python" data-sourcepos="46:1-210:3"><div class="highlight"><pre><code><span class="kn">import</span> <span class="n">sys</span>
<span class="kn">import</span> <span class="n">json</span>
...
<span class="k">def</span> <span class="nf">escape</span><span class="p">(</span><span class="nb">input</span><span class="p">:</span><span class="nb">str</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
  <span class="k">return</span> <span class="nb">input</span><span class="p">.</span><span class="nf">replace</span><span class="p">(</span><span class="sh">'</span><span class="se">\\\\</span><span class="sh">'</span><span class="p">,</span> <span class="sh">'</span><span class="se">\\\\\\\\</span><span class="sh">'</span><span class="p">)</span>\\
              ...
              <span class="p">.</span><span class="nf">replace</span><span class="p">(</span><span class="sh">'</span><span class="s">${"$"}{"{"${"$"}{"}"}</span><span class="sh">'</span><span class="p">,</span> <span class="sh">'</span><span class="s">${"$"}${"$"}{"{"${"$"}{"}"}</span><span class="sh">"</span><span class="s">${"$"}{"{"${"$"}{"}"}</span><span class="sh">"</span><span class="s">${"$"}{"}"}</span><span class="sh">'</span><span class="p">)</span>\\
              <span class="p">.</span><span class="nf">replace</span><span class="p">(</span><span class="sh">'</span><span class="s">${"$"}{"}"}</span><span class="sh">'</span><span class="p">,</span> <span class="sh">'</span><span class="s">${"$"}${"$"}{"{"${"$"}{"}"}</span><span class="sh">"</span><span class="s">${"$"}{"}"}</span><span class="sh">"</span><span class="s">${"$"}{"}"}</span><span class="sh">'</span><span class="p">)</span>\\
              <span class="p">.</span><span class="nf">replace</span><span class="p">(</span><span class="sh">'</span><span class="s">${"$"}</span><span class="sh">'</span><span class="p">,</span> <span class="sh">'</span><span class="s">${"$"}${"$"}{"{"${"$"}{"}"}</span><span class="sh">"</span><span class="s">${"$"}</span><span class="sh">"</span><span class="s">${"$"}{"}"}</span><span class="sh">'</span><span class="p">)</span>
...
<span class="k">def</span> <span class="nf">Group</span><span class="p">(</span><span class="n">grp</span><span class="p">:</span><span class="nb">dict</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
  <span class="nf">if</span><span class="p">(</span><span class="n">grp</span> <span class="ow">is</span> <span class="bp">None</span><span class="p">):</span>
    <span class="k">return</span> <span class="nc">Empty</span><span class="p">()</span>

  <span class="n">created_at</span> <span class="o">=</span> <span class="n">grp</span><span class="p">[</span><span class="sh">'</span><span class="s">created_at</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">description</span> <span class="o">=</span> <span class="n">grp</span><span class="p">[</span><span class="sh">'</span><span class="s">description</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">name</span> <span class="o">=</span> <span class="n">grp</span><span class="p">[</span><span class="sh">'</span><span class="s">name</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">private</span> <span class="o">=</span> <span class="n">grp</span><span class="p">[</span><span class="sh">'</span><span class="s">private</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">updated_at</span> <span class="o">=</span> <span class="n">grp</span><span class="p">[</span><span class="sh">'</span><span class="s">updated_at</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">url_name</span> <span class="o">=</span> <span class="n">grp</span><span class="p">[</span><span class="sh">'</span><span class="s">url_name</span><span class="sh">'</span><span class="p">]</span>

  <span class="n">arr</span> <span class="o">=</span> <span class="p">[]</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">created_at: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">created_at</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">description: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">description</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">name: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">name</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">private: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="nf">str</span><span class="p">(</span><span class="n">private</span><span class="p">).</span><span class="n">lower</span><span class="si">${"$"}{"}"}</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">updated_at: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">updated_at</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">url_name: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">url_name</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="k">return</span> <span class="sh">'</span><span class="s">${"$"}{"{"${"$"}{"}"}</span><span class="sh">'</span> <span class="o">+</span> <span class="sh">'</span><span class="s">,</span><span class="se">\\n</span><span class="sh">'</span><span class="p">.</span><span class="nf">join</span><span class="p">(</span><span class="n">arr</span><span class="p">)</span> <span class="o">+</span>  <span class="sh">'</span><span class="s">${"$"}{"}"}</span><span class="sh">'</span>
...
<span class="k">def</span> <span class="nf">Tag</span><span class="p">(</span><span class="n">tag</span><span class="p">:</span><span class="nb">dict</span><span class="p">):</span>
  <span class="n">name</span> <span class="o">=</span> <span class="n">tag</span><span class="p">[</span><span class="sh">'</span><span class="s">name</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">versions</span> <span class="o">=</span> <span class="n">tag</span><span class="p">[</span><span class="sh">'</span><span class="s">versions</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">arr</span> <span class="o">=</span> <span class="p">[]</span>
  <span class="n">delimiter</span> <span class="o">=</span> <span class="sh">'</span><span class="s">,</span><span class="sh">'</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">name: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">name</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">vals</span> <span class="o">=</span> <span class="n">delimiter</span><span class="p">.</span><span class="nf">join</span><span class="p">(</span><span class="nf">map</span><span class="p">(</span><span class="k">lambda</span> <span class="n">v</span><span class="p">:</span> <span class="sa">f</span><span class="sh">'</span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">v</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span> <span class="p">,</span><span class="n">versions</span><span class="p">))</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">versions: [ </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">vals</span><span class="si">${"$"}{"}"}</span><span class="s"> ]</span><span class="sh">'</span><span class="p">)</span>
  <span class="k">return</span> <span class="sh">'</span><span class="s">${"$"}{"{"${"$"}{"}"}</span><span class="sh">'</span> <span class="o">+</span> <span class="n">delimiter</span><span class="p">.</span><span class="nf">join</span><span class="p">(</span><span class="n">arr</span><span class="p">)</span> <span class="o">+</span> <span class="sh">'</span><span class="s">${"$"}{"}"}</span><span class="sh">'</span>


<span class="k">def</span> <span class="nf">Tags</span><span class="p">(</span><span class="n">tags</span><span class="p">):</span>
  <span class="n">tags</span> <span class="o">=</span> <span class="nf">map</span><span class="p">(</span><span class="k">lambda</span> <span class="n">tag</span><span class="p">:</span> <span class="nc">Tag</span><span class="p">(</span><span class="n">tag</span><span class="p">),</span> <span class="n">tags</span><span class="p">)</span>
  <span class="n">arr</span> <span class="o">=</span> <span class="p">[]</span>
  <span class="k">for</span> <span class="n">tag</span> <span class="ow">in</span> <span class="n">tags</span><span class="p">:</span>
    <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="n">tag</span><span class="p">)</span>

  <span class="k">return</span> <span class="sh">'</span><span class="s">[</span><span class="sh">'</span> <span class="o">+</span> <span class="sh">'</span><span class="s">,</span><span class="sh">'</span><span class="p">.</span><span class="nf">join</span><span class="p">(</span><span class="n">arr</span><span class="p">)</span> <span class="o">+</span> <span class="sh">'</span><span class="s">]</span><span class="sh">'</span>
...
<span class="k">def</span> <span class="nf">User</span><span class="p">(</span><span class="n">user</span><span class="p">:</span><span class="nb">dict</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
  <span class="n">description</span> <span class="o">=</span> <span class="n">user</span><span class="p">[</span><span class="sh">'</span><span class="s">description</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">facebook_id</span> <span class="o">=</span> <span class="n">user</span><span class="p">[</span><span class="sh">'</span><span class="s">facebook_id</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">followees_count</span> <span class="o">=</span> <span class="n">user</span><span class="p">[</span><span class="sh">'</span><span class="s">followees_count</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">followers_count</span> <span class="o">=</span> <span class="n">user</span><span class="p">[</span><span class="sh">'</span><span class="s">followers_count</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">github_login_name</span> <span class="o">=</span> <span class="n">user</span><span class="p">[</span><span class="sh">'</span><span class="s">github_login_name</span><span class="sh">'</span><span class="p">]</span>
  <span class="nb">id</span> <span class="o">=</span> <span class="n">user</span><span class="p">[</span><span class="sh">'</span><span class="s">id</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">items_count</span> <span class="o">=</span> <span class="n">user</span><span class="p">[</span><span class="sh">'</span><span class="s">items_count</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">linkedin_id</span> <span class="o">=</span> <span class="n">user</span><span class="p">[</span><span class="sh">'</span><span class="s">linkedin_id</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">location</span> <span class="o">=</span> <span class="n">user</span><span class="p">[</span><span class="sh">'</span><span class="s">location</span><span class="sh">'</span><span class="p">]</span>
  ...
  <span class="n">organization</span> <span class="o">=</span> <span class="n">user</span><span class="p">[</span><span class="sh">'</span><span class="s">organization</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">permanent_id</span> <span class="o">=</span> <span class="n">user</span><span class="p">[</span><span class="sh">'</span><span class="s">permanent_id</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">profile_image_url</span> <span class="o">=</span> <span class="n">user</span><span class="p">[</span><span class="sh">'</span><span class="s">profile_image_url</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">team_only</span> <span class="o">=</span> <span class="n">user</span><span class="p">[</span><span class="sh">'</span><span class="s">team_only</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">twitter_screen_name</span> <span class="o">=</span> <span class="n">user</span><span class="p">[</span><span class="sh">'</span><span class="s">twitter_screen_name</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">website_url</span> <span class="o">=</span> <span class="n">user</span><span class="p">[</span><span class="sh">'</span><span class="s">website_url</span><span class="sh">'</span><span class="p">]</span>

  <span class="n">arr</span> <span class="o">=</span> <span class="p">[]</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">description: \`</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">description</span><span class="si">${"$"}{"}"}</span><span class="s">\`</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">facebook_id: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">facebook_id</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">followees_count: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">followees_count</span><span class="si">${"$"}{"}"}</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">followers_count: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">followers_count</span><span class="si">${"$"}{"}"}</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">github_login_name: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">github_login_name</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">id: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="nb">id</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">items_count: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">items_count</span><span class="si">${"$"}{"}"}</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">linkedin_id: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">linkedin_id</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">location: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">location</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">name: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">name</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">organization: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">organization</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">permanent_id: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">permanent_id</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">profile_image_url: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">profile_image_url</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">team_only: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="nf">str</span><span class="p">(</span><span class="n">team_only</span><span class="p">).</span><span class="nf">lower</span><span class="p">()</span><span class="si">${"$"}{"}"}</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">twitter_screen_name: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">twitter_screen_name</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">website_url: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">website_url</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
...
<span class="k">def</span> <span class="nf">TeamMembership</span><span class="p">(</span><span class="n">tm</span><span class="p">:</span><span class="nb">dict</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
  <span class="nf">if</span><span class="p">(</span><span class="n">tm</span> <span class="ow">is</span> <span class="bp">None</span><span class="p">):</span>
    <span class="k">return</span> <span class="nc">Empty</span><span class="p">()</span>

  <span class="n">arr</span> <span class="o">=</span> <span class="p">[]</span>
  <span class="n">name</span> <span class="o">=</span> <span class="n">tm</span><span class="p">[</span><span class="sh">'</span><span class="s">name</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">name: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">name</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="k">return</span> <span class="sh">'</span><span class="s">${"$"}{"{"${"$"}{"}"}</span><span class="sh">'</span> <span class="o">+</span> <span class="sh">'</span><span class="s">,</span><span class="sh">'</span><span class="p">.</span><span class="nf">join</span><span class="p">(</span><span class="n">arr</span><span class="p">)</span> <span class="o">+</span> <span class="sh">'</span><span class="s">${"$"}{"}"}</span><span class="sh">'</span>
...
<span class="k">def</span> <span class="nf">Item</span><span class="p">(</span><span class="n">item</span><span class="p">:</span><span class="nb">dict</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
  <span class="n">arr</span> <span class="o">=</span> <span class="p">[]</span>
  <span class="n">rendered_body</span> <span class="o">=</span> <span class="nf">escape</span><span class="p">(</span><span class="n">item</span><span class="p">[</span><span class="sh">'</span><span class="s">rendered_body</span><span class="sh">'</span><span class="p">])</span>
  <span class="n">body</span> <span class="o">=</span> <span class="nf">escape</span><span class="p">(</span><span class="n">item</span><span class="p">[</span><span class="sh">'</span><span class="s">body</span><span class="sh">'</span><span class="p">])</span>
  <span class="n">coediting</span> <span class="o">=</span> <span class="n">item</span><span class="p">[</span><span class="sh">'</span><span class="s">coediting</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">comments_count</span> <span class="o">=</span> <span class="n">item</span><span class="p">[</span><span class="sh">'</span><span class="s">comments_count</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">created_at</span> <span class="o">=</span> <span class="n">item</span><span class="p">[</span><span class="sh">'</span><span class="s">created_at</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">group</span> <span class="o">=</span> <span class="nc">Group</span><span class="p">(</span><span class="n">item</span><span class="p">[</span><span class="sh">'</span><span class="s">group</span><span class="sh">'</span><span class="p">])</span> <span class="k">if</span> <span class="sh">'</span><span class="s">group</span><span class="sh">'</span> <span class="ow">in</span> <span class="n">item</span> <span class="k">else</span> <span class="nc">Empty</span><span class="p">()</span>
  <span class="nb">id</span> <span class="o">=</span> <span class="n">item</span><span class="p">[</span><span class="sh">'</span><span class="s">id</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">likes_count</span> <span class="o">=</span> <span class="n">item</span><span class="p">[</span><span class="sh">'</span><span class="s">likes_count</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">private</span> <span class="o">=</span> <span class="n">item</span><span class="p">[</span><span class="sh">'</span><span class="s">private</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">reactions_count</span> <span class="o">=</span> <span class="n">item</span><span class="p">[</span><span class="sh">'</span><span class="s">reactions_count</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">tags</span> <span class="o">=</span> <span class="nc">Tags</span><span class="p">(</span><span class="n">item</span><span class="p">[</span><span class="sh">'</span><span class="s">tags</span><span class="sh">'</span><span class="p">])</span> <span class="k">if</span> <span class="sh">'</span><span class="s">tags</span><span class="sh">'</span> <span class="ow">in</span> <span class="n">item</span> <span class="k">else</span> <span class="sh">'</span><span class="s">[]</span><span class="sh">'</span>
  <span class="n">title</span> <span class="o">=</span> <span class="n">item</span><span class="p">[</span><span class="sh">'</span><span class="s">title</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">updated_at</span> <span class="o">=</span> <span class="n">item</span><span class="p">[</span><span class="sh">'</span><span class="s">updated_at</span><span class="sh">'</span><span class="p">]</span>
  ...
  <span class="n">user</span> <span class="o">=</span> <span class="nc">User</span><span class="p">(</span><span class="n">item</span><span class="p">[</span><span class="sh">'</span><span class="s">user</span><span class="sh">'</span><span class="p">])</span> <span class="k">if</span> <span class="sh">'</span><span class="s">user</span><span class="sh">'</span> <span class="ow">in</span> <span class="n">item</span> <span class="k">else</span> <span class="nc">Empty</span><span class="p">()</span>
  <span class="n">page_views_count</span> <span class="o">=</span> <span class="n">item</span><span class="p">[</span><span class="sh">'</span><span class="s">page_views_count</span><span class="sh">'</span><span class="p">]</span>
  <span class="n">team_membership</span> <span class="o">=</span> <span class="nc">TeamMembership</span><span class="p">(</span><span class="n">item</span><span class="p">[</span><span class="sh">'</span><span class="s">team_membership</span><span class="sh">'</span><span class="p">])</span> <span class="k">if</span> <span class="sh">'</span><span class="s">team_membership</span><span class="sh">'</span> <span class="ow">in</span> <span class="n">item</span> <span class="k">else</span> <span class="nc">Empty</span><span class="p">()</span>

  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">rendered_body: \`</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">rendered_body</span><span class="si">${"$"}{"}"}</span><span class="s">\`</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">body: \`</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">body</span><span class="si">${"$"}{"}"}</span><span class="s">\`</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">coediting: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="nf">str</span><span class="p">(</span><span class="n">coediting</span><span class="p">).</span><span class="nf">lower</span><span class="p">()</span><span class="si">${"$"}{"}"}</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">comments_count: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">comments_count</span><span class="si">${"$"}{"}"}</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">created_at: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">created_at</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">group: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">group</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">id: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="nb">id</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">likes_count: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">likes_count</span><span class="si">${"$"}{"}"}</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">private: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="nf">str</span><span class="p">(</span><span class="n">private</span><span class="p">).</span><span class="nf">lower</span><span class="p">()</span><span class="si">${"$"}{"}"}</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">reactions_count: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">reactions_count</span><span class="si">${"$"}{"}"}</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">tags: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">tags</span><span class="si">${"$"}{"}"}</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">title: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">title</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">updated_at: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">updated_at</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">url: </span><span class="se">\\'</span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">url</span><span class="si">${"$"}{"}"}</span><span class="se">\\'</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">user: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">user</span><span class="si">${"$"}{"}"}</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">page_views_count: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="sh">"</span><span class="s">null</span><span class="sh">"</span> <span class="k">if</span> <span class="n">page_views_count</span> <span class="ow">is</span> <span class="bp">None</span> <span class="k">else</span> <span class="n">page_views_count</span><span class="si">${"$"}{"}"}</span><span class="sh">'</span><span class="p">)</span>
  <span class="n">arr</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="sa">f</span><span class="sh">'</span><span class="s">team_membership: </span><span class="si">${"$"}{"{"${"$"}{"}"}</span><span class="n">team_membership</span><span class="si">${"$"}{"}"}</span><span class="sh">'</span><span class="p">)</span>
...
<span class="k">def</span> <span class="nf">main</span><span class="p">(</span><span class="n">out_path</span><span class="p">):</span>
  ...
  <span class="k">for</span> <span class="n">item</span> <span class="ow">in</span> <span class="n">items</span><span class="p">:</span>
    <span class="n">it</span> <span class="o">=</span> <span class="nc">Item</span><span class="p">(</span><span class="n">item</span><span class="p">)</span>
    <span class="n">lines</span><span class="p">.</span><span class="nf">append</span><span class="p">(</span><span class="n">it</span><span class="p">)</span>



  <span class="n">text</span> <span class="o">=</span> <span class="sh">'</span><span class="s">export const articles = [</span><span class="sh">'</span> <span class="o">+</span> <span class="sh">'</span><span class="s">,</span><span class="sh">'</span><span class="p">.</span><span class="nf">join</span><span class="p">(</span><span class="n">lines</span><span class="p">)</span> <span class="o">+</span> <span class="sh">'</span><span class="s">]</span><span class="sh">'</span>
  <span class="k">if</span> <span class="n">os</span><span class="p">.</span><span class="n">path</span><span class="p">.</span><span class="nf">exists</span><span class="p">(</span><span class="n">os</span><span class="p">.</span><span class="n">path</span><span class="p">.</span><span class="nf">dirname</span><span class="p">(</span><span class="n">out_path</span><span class="p">))</span> <span class="o">==</span> <span class="bp">False</span><span class="p">:</span>
    <span class="n">os</span><span class="p">.</span><span class="nf">makedirs</span><span class="p">(</span><span class="n">os</span><span class="p">.</span><span class="n">path</span><span class="p">.</span><span class="nf">dirname</span><span class="p">(</span><span class="n">out_path</span><span class="p">))</span>
  <span class="n">f</span> <span class="o">=</span> <span class="n">io</span><span class="p">.</span><span class="nf">open</span><span class="p">(</span><span class="n">out_path</span><span class="p">,</span> <span class="sh">'</span><span class="s">w</span><span class="sh">'</span><span class="p">)</span>
...
<span class="k">export</span> <span class="kd">const</span> <span class="nx">apiPlugin</span><span class="p">:</span> <span class="nx">Plugin</span> <span class="o">=</span> <span class="p">(</span><span class="nx">context</span><span class="p">,</span> <span class="nx">inject</span><span class="p">):</span> <span class="k">void</span> <span class="o">=&gt;</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
  <span class="kd">const</span> <span class="nx">qiitaAxios</span> <span class="o">=</span> <span class="nx">context</span><span class="p">.</span><span class="nx">${"$"}axios</span><span class="p">.</span><span class="nf">create</span><span class="p">(${"$"}{"{"${"$"}{"}"}</span>
  ...
  <span class="nf">inject</span><span class="p">(</span><span class="dl">'</span><span class="s1">qiitaApi</span><span class="dl">'</span><span class="p">,</span> <span class="k">new</span> <span class="nc">QiitaApi</span><span class="p">(</span><span class="nx">qiitaAxios</span><span class="p">))</span>
<span class="p">${"$"}{"}"}</span>
...
<span class="k">export</span> <span class="k">default</span> <span class="kd">class</span> <span class="nc">QiitaApi</span> <span class="k">implements</span> <span class="nx">IApi</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
  ...
  <span class="nf">constructor </span><span class="p">(</span><span class="nx">axios</span><span class="p">:</span> <span class="nx">NuxtAxiosInstance</span><span class="p">)</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
    <span class="k">this</span><span class="p">.</span><span class="nx">axios</span> <span class="o">=</span> <span class="nx">axios</span>
  <span class="p">${"$"}{"}"}</span>

  <span class="k">public</span> <span class="k">async</span> <span class="nf">getMyQiitaItems </span><span class="p">():</span> <span class="nb">Promise</span><span class="o">&lt;</span><span class="nx">PostData</span><span class="p">[]</span><span class="o">&gt;</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
     ...
     <span class="k">try</span> <span class="p">${"$"}{"{"${"$"}{"}"}</span>
       <span class="kd">const</span> <span class="na">response</span> <span class="p">:</span> <span class="nx">PostData</span><span class="p">[]</span> <span class="o">=</span> <span class="k">await</span> <span class="k">this</span><span class="p">.</span><span class="nx">axios</span><span class="p">.</span><span class="nf">${"$"}get</span><span class="p">(</span><span class="nx">url</span><span class="p">)</span>
...
<p data-sourcepos="58:1-58:54"><iframe id="qiita-embed-content__bd676528baf4c66e2b18cb27a23fcd8e" src="https://qiita.com/embed-contents/link-card#qiita-embed-content__bd676528baf4c66e2b18cb27a23fcd8e" data-content="https%3A%2F%2Fapps.apple.com%2Fjp%2Fapp%2Froutinetree%2Fid1600469504" frameborder="0" scrolling="no" loading="lazy" style="width:100%;" height="29">
</iframe>
</p>
